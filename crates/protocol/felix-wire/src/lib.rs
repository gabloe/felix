...
pub use client::features::{
    ...
    FEATURE_IDEMPOTENT_PRODUCER, FEATURE_REDIRECT, FEATURE_SHARD_MOVED, FEATURE_STREAM_SHARDS,
    FEATURE_TOPOLOGY, KNOWN_FEATURES, supports_feature,
};
pub use client::flags::{
    FLAG_BINARY_EVENT_BATCH, FLAG_BINARY_EVENT_BATCH_SHARED, FLAG_BINARY_PUBLISH_ACK,
    FLAG_BINARY_PUBLISH_ACK_CODE, FLAG_BINARY_PUBLISH_ACK_DETAIL, FLAG_BINARY_PUBLISH_ACK_OWNER,
    FLAG_BINARY_PUBLISH_ACKED, FLAG_BINARY_PUBLISH_BATCH, FLAG_BINARY_PUBLISH_IDEMPOTENT,
    FLAG_BINARY_PUBLISH_KEYED, FLAG_EVENT_BATCH_OFFSETS, KNOWN_FLAGS, ORIGINAL_V1_FLAGS,
    has_unknown_flags, supports,
};
