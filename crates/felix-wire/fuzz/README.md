...
`crates/felix-storage/fuzz`, and why the properties here are about refusing
...
`crates/felix-wire/tests/wire_fuzz.rs`, so a regression in the obvious cases
