...
Run it alongside [Slow-consumer Isolation](slow-consumer-isolation.md). That one
shows Felix's shipped strength; this one shows what that strength costs.

## Why this exists

[What Felix is for](../getting-started/what-felix-is-for.md) describes the target as
...
trade-off [Slow-consumer Isolation](slow-consumer-isolation.md) measures. Neither
column is free.
