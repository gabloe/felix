# Internals: Backpressure & Core Sharding
...
[Internals: The Publish Path](internals-publish.md) and
[Internals: Subscribe & Fanout](internals-subscribe.md). This page is the
...
[Benchmarks](../features/benchmarks.md) page measures.
...
[Internals: The Publish Path](internals-publish.md#client-side-publisherpublish)),
3-4 are broker ingest, 5-6 are broker egress (see
[Internals: Subscribe & Fanout](internals-subscribe.md)). Below that, QUIC's
...
unbounded tail latency. The [Benchmarks](../features/benchmarks.md) harness
...
[Benchmarks: Core Sharding](../features/benchmarks.md) for measured impact
