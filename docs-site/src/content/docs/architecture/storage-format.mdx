...
Implementation:
[`crates/felix-storage/src/segment/format.rs`](https://github.com/gabloe/felix/blob/main/crates/felix-storage/src/segment/format.rs).
...
[`segment/reader.rs`](https://github.com/gabloe/felix/blob/main/crates/felix-storage/src/segment/reader.rs).
