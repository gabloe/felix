...
| `FELIX_KAFKA_LISTEN` | unset | Address the Kafka-protocol listener binds (read-only Kafka consume). Unset turns the listener off. See `docs/kafka-compatibility.md`. |
