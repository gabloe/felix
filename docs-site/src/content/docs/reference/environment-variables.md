...
| `FELIX_NODE_TOKEN` / `FELIX_NODE_TOKEN_FILE` | — | Access credential this broker presents to the control plane. Short-lived; see the refresh file below, without which the broker leaves the cluster when this expires. |
