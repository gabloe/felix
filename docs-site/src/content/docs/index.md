...
<p align="center">
  <img src="/felix/logo.png" alt="Felix logo" width="360" />
</p>
...
See the [Demos Overview](/felix/demos/overview/) or the [Quickstart Guide](/felix/getting-started/quickstart/) for detailed instructions.
...
**Ready to dive in?** Start with the [Overview](/felix/getting-started/overview/) or jump straight to the [Quickstart Guide](/felix/getting-started/quickstart/).
