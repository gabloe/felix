...
| Kafka Produce | 🎯 Target | Not started. The Kafka listener advertises `Produce` because librdkafka needs to see it, and refuses every one with `POLICY_VIOLATION`. Publish with a Felix client |
