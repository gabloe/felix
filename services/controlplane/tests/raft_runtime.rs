...
use controlplane::store::command::{MetaCommand, encode_command};
...
fn seed_operator(addr: SocketAddr) -> String {
    ...
    let keys = controlplane::auth::felix_token::TenantSigningKeys {
    ...
    let exported = runtime.block_on(async {
        ...
        seed.create_tenant(controlplane::model::Tenant {
