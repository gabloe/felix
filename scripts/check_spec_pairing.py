...
MODELLED = (
    "services/broker/src/lease",
    "services/broker/src/replication",
    "services/broker/src/shard_lifecycle",
    "services/controlplane/src/placement",
    "services/controlplane/src/replica_positions",
)
SPEC = "docs/formal/"
